                ...
                .then(data => {
                    if (!Array.isArray(data) || data.length === 0) {
                        ...
                        data.forEach(friend => {
                            ...
                            div.className = 'flex items-center justify-between py-2 px-4 bg-gray-100 rounded mb-2';
                            ...
                            messageBtn.className = 'text-gray-500 hover:text-primary transition-colors';
                            messageBtn.title = 'Send message to ' + friend;
                            messageBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-dots-fill" viewBox="0 0 16 16">
  <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4.414a1 1 0 0 0-.707.293L.854 15.146A.5.5 0 0 1 0 14.793zm5 4a1 1 0 1 0-2 0 1 1 0 0 0 2 0m4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0m3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/>
</svg>`;
                            messageBtn.onclick = () => {
                                // TODO: Implement messaging functionality
                                console.log('Message button clicked for:', friend);
                            };
